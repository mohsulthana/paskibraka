...
<body>
				...
				<div class="left-sidebar-pro">
								<nav id="sidebar" class="">
												<div class="sidebar-header">
																<a href="<?php echo base_url() ?>/Admin/homepimpinan"><h3>Paskibraka SumSel</a>
				...
				<div class="all-content-wrapper">
								<div class="container-fluid">
												<div class="row">
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																				<div class="logo-pro">
																								<a href="<?php echo base_url() ?>/Admin/homepimpinan"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
																				</div>
																</div>
												</div>
								</div>
								...
								<!-- Batas Tanda -->
								<div class="logo-pro">
											<a href="<?php echo base_url() ?>/Admin/home"><br><img class="main-logo" align="center" src="<?php echo base_url() ?>img/paskibraka.jpeg" alt="" /></a>
								</div>
