...
<body>
																				...
																				<ul class="metismenu" id="menu1">
																								<li class="active">
																												...
																												<ul class="submenu-angle" aria-expanded="true">
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>Admin/lihatuser"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Data User</span></a></li>
				...
				<div class="all-content-wrapper">
								...
								<!-- Batas Tanda -->
								<div class="logo-pro">
											<a href="<?php echo base_url() ?>/Admin/home"><img class="main-logo" align="center" src="<?php echo base_url() ?>img/paskibraka.jpeg" alt="" /></a>
								</div>
