																																								...
																																								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																																												<div class="all-form-element-inner">
																																													<!--  <input name="nisn" type="text" class="form-control"> -->
																																																<form action="<?php echo base_url() ?>/User/insert_data_siswa" method="post" enctype="multipart/form-data">
																																																	...
																																																	<div class="form-group-inner">
																																																								...
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-3 col-sm-3 col-xs-3">
																																																																<div class="bt-df-checkbox">
																																																																			<label>	<input class="pull-left radio-checked" type="radio" checked="" value="Laki-laki" id="optionsRadios1" name="jeniskelamin">Laki-laki</label>
																																																																			<label><input class="pull-left" type="radio" value="Perempuan" id="optionsRadios2" name="jeniskelamin">Perempuan </label>
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
																																																								...
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
																																																																<div class="file-upload-inner ts-forms">
																																																																												<input type="file" name="surat_delegasi" onchange="document.getElementById('prepend-small-btn').value = this.value;">
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
																																																																<div class="file-upload-inner ts-forms">
																																																																												<input type="file" name="aktif_sekolah" onchange="document.getElementById('prepend-small-btn').value = this.value;">	
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
																																																																<div class="file-upload-inner ts-forms">
																																																																												<input type="file" name="izin_ortu" onchange="document.getElementById('prepend-small-btn').value = this.value;">
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
																																																																<div class="file-upload-inner ts-forms">
																																																																												<input type="file" name="surat_sehat" onchange="document.getElementById('prepend-small-btn').value = this.value;">	
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
																																																					<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
																																																																<div class="file-upload-inner ts-forms">
																																																																												<input type="file" name="biodata" onchange="document.getElementById('prepend-small-btn').value = this.value;">
																																																																</div>
																																																												</div>
																																																								</div>
																																																				</div>
