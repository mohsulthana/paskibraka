...
<head>
				...
				<title>Paskibraka Provinsi Sumatera Selatan</title>
...
<body>
				<!--[if lt IE 8]>
								...
								<nav id="sidebar" class="">
												<div class="sidebar-header">
																<a href="<?php echo base_url() ?>/User/home"><h3>Paskibraka SumSel</a>
																				...
																				<ul class="metismenu" id="menu1">
																								<li class="active">
																												...
																												<ul class="submenu-angle" aria-expanded="true">
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/User/pendaftaran"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Form Pendaftaran</span></a></li>
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/User/datadiri"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lihat Data</span></a></li>
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/User/hasil"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lihat Hasil</span></a></li>
																												</ul>
																								</li>
			...
			<div class="all-content-wrapper">
								<div class="container-fluid">
												<div class="row">
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																				<div class="logo-pro">
																								<a href="<?php echo base_url() ?>/User/home"><img class="main-logo" src="<?php echo base_url() ?>img/logo/logo.png" alt="" /></a>
																				</div>
																</div>
												</div>
								</div>
																																				...
																																				<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
																																								<div class="header-top-menu tabl-d-n">
																																												<ul class="nav navbar-nav mai-top-nav">
																																																<li class="nav-item"><a href="<?php echo base_url() ?>/User/home" class="nav-link">Home</a>
																																																</li>
																																																<li class="nav-item"><a href="<?php echo base_url() ?>/User/tentang" class="nav-link">About</a>
																																																</li>
																																												</ul>
																																								</div>
																																				</div>
																																															...
																																															<li class="nav-item dropdown">
																																																				...
																																																				<div role="menu" class="author-message-top dropdown-menu animated zoomIn">
																																																								<div class="message-single-top">
																																																												...
																																																												<li>
																																																																<a href="#">
																																																																				<div class="message-img">
																																																																								<img src="<?php echo base_url() ?>img/contact/4.jpg" alt="">
																																																																				</div>
																																																																				<div class="message-content">
																																																																								<span class="message-date">2018</span>
																																																																								<h2>Hanum Sabrina</h2>
																																																																								<p>Banyak bertemu teman baru!</p>
																																																																				</div>
																																																																</a>
																																																												</li>
																																																...
																																																<li class="nav-item">
																																																				<a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
																																																												...
																																																												<span class="admin-name">Aksi User</span>
																																																												<i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
																																																								</a>
																																																				<ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
				
																																																								<li><a href="<?php echo base_url() ?>/User/logout"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
																																																								</li>
																																																				</ul>
																																																</li>
								...
								<!-- Batas Tanda -->
								<div class="logo-pro">
											<a href="<?php echo base_url() ?>/User/home"><img class="main-logo" align="center" src="<?php echo base_url() ?>img/paskibraka.jpeg" alt="" /></a>
								</div>
																																																	...
																																																	<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="text" name="nisn" value="<?php echo $this->session->userdata('nisn'); ?>" class="form-control" disabled="">
																																																												</div>
																																																								</div>
																																																				</div>
																																																				...
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="text" name="nomorhp" class="form-control" value="<?php echo $row["HP"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="text" name="kelas" class="form-control" value="<?php echo $row["Kelas"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				...
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="text" name="sekolah" class="form-control" value="<?php echo $row["Sekolah"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				...
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																	<input type="text" name="daerah" class="form-control" value="<?php echo $row["Daerah"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-3 col-sm-3 col-xs-3">
																																																																<input type="text" name="jeniskelamin" class="form-control" value="<?php echo $row["JK"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="integer" name="tinggibadan" class="form-control" value="<?php echo $row["TB"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="integer" name="beratbadan" class="form-control" value="<?php echo $row["BB"]; ?>" disabled />
																																																												</div>
																																																								</div>
																																																				</div>
																																																				...
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																											...
																																																											<input type="integer" name="delegasi" class="form-control" value="<?php echo $row["Delegasi"]; ?>" disabled />
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
																																																														...
																																																														<input type="integer" name="aktif_sekolah" class="form-control" value="<?php echo $row["Aktif_Sekolah"]; ?>" disabled />
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
																																																														...
																																																														<input type="integer" name="izin_ortu" class="form-control" value="<?php echo $row["Izin_Ortu"]; ?>" disabled />
																																																								</div>
																																																				</div>
																																																				<div class="form-group-inner">
																																																								<div class="row">
																																																												<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
																																																														...
																																																														<input type="integer" name="surat_sehat" class="form-control" value="<?php echo $row["Surat_Kesehatan"]; ?>" disabled />
																																																								</div>
																																																				</div>
																																																					<div class="form-group-inner">
																																																								<div class="row">
																																																												<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
																																																														...
																																																														<input type="integer" name="biodata" class="form-control" value="<?php echo $row["Biodata"]; ?>" disabled />
																																																								</div>
																																																				</div>
																																																					<div class="form-group-inner">
																																																								<div class="row">
																																																												<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
																																																														...
																																																														<input type="integer" name="foto" class="form-control" value="<?php echo $row["Foto"]; ?>" disabled />
																																																								</div>
																																																				</div>
