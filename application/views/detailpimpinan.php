																				...
																				<ul class="metismenu" id="menu1">
																								<li class="active">
																												...
																												<ul class="submenu-angle" aria-expanded="true">
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/Admin/kriteria_pimpinan"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Kriteria dan Bobot</span></a></li>
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/Admin/datapendaftarpimpinan"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Data Pendaftar</span></a></li>
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/Admin/rankingpimpinan"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lihat Ranking</span></a></li>
																												</ul>
																								</li>
																																				...
																																				<div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
																																								<div class="header-top-menu tabl-d-n">
																																												<ul class="nav navbar-nav mai-top-nav">
																																																<li class="nav-item"><a href="<?php echo base_url() ?>/Admin/homepimpinan" class="nav-link">Home</a>
																																																</li>
																																																	...
																																																	<div class="form-group-inner">
																																																								<div class="row">
																																																												...
																																																												<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																																																																<input type="text" name="nisn" value="<?php echo $row["NISN"]; ?>" class="form-control" disabled="">
																																																												</div>
																																																								</div>
																																																				</div>
