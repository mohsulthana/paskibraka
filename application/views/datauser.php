																				...
																				<ul class="metismenu" id="menu1">
																								<li class="active">
																												...
																												<ul class="submenu-angle" aria-expanded="true">
																																<li><a title="Dashboard v.1" href="<?php echo base_url() ?>/Admin/datauser"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Data User</span></a></li>
                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                      ...
                                      <input type="submit" value="Input User" name="submit">
