                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><div>
                                                		...
                                                		<input type="submit" value="Lulus" name="submit">
                                                		<input type="text" value="<?php echo $row["NISN"]; ?>" name="nisn" hidden>
                                                	</form></div>
                                                		<div><form action="<?php echo base_url() ?>/Admin/status_tidak_lulus" method="post"> 
                                                			<input type="text" value="<?php echo $row["NISN"]; ?>" name="nisn" hidden>
                                                			<input type="submit" value="Tidak Lulus" name="submit"></form></div>
                                               	</td>
